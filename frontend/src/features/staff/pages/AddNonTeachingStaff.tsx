...
const AddNonTeachingStaff: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await nonTeachingStaffApi.create(apiData);
      
      setToast({ message: 'Non-teaching staff added successfully!', type: 'SUCCESS' });
      ...
      setToast({ 
        message: error.message || 'Failed to add non-teaching staff', 
        type: 'ERROR' 
      });
    } finally {
      setIsLoading(false);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Add Non-Teaching Staff</h1>
